...
mem_list = ["64G"]
#mem_list 	= ["20G", "90G"] #, "20G", "40G", "60G", "90G", "110G"]
#mem_list 	= ["10G", "20G", "40G", "60G", "90G", "110G"]
#mem_list	= ["16G", "8G", "4G", "2G", "1G", "500M", "250M"]

#mem_list 	= ["250M", "500M", "1G", "2G", "4G", "8G"]#, "16G"]
#mem_list 	= ["20G"] #, "500M", "1G", "2G", "4G", "8G"]#, "16G"]

#seqlen_list = ["5M", "10M", "35M", "40M"] 
seqlen_list = ["5M", "10M", "15M", "20M", "25M", "30M", "35M", "40M"]
#seqlen_list = ["5M"]

#ppn_list = [2]
ppn_list = [2, 5, 8, 11]     #numactl 3, 6, 9, 12 cores respectively

#ppn_list 	= [2, 20] #, 4, 8, 12, 16, 20, 24]
...
realRemoteDir = "/oasis/scratch/comet/a3rao/temp_project/NGS-ann-project" #send this: to get exec and data
#realRemoteDataDir = realRemoteDir + "/dataFiles"
#RemoteProjectDir = "/scratch/\"$USER/$SLURM_JOBID\""
...
InputDir = RemoteProjectDir 	+ "/data" 				#+ SampleName + "/filter-human"
ReadSplitDir = RemoteProjectDir + "/read-split"
NumOfSplit = "512"
realRemoteOutputDir = realRemoteDir + "/" + SampleName + "/qsubErrOut/" + JobFolderName #send this: copy output here
...
for i in range (0, num_combs):
	...
	seqLength = 'seqlen'+str(seqlen) 													# send this: as input to help with copying
	...
	for c in range (1, NumOfIterations+1):
		...
		p = subprocess.check_call(
								...
								#NEW copy results to this
								'-' + wf_module_name + 'realRemoteDir', realRemoteDir, 				
								#NEW get exec and data from here
								...
								'/home/comet/workflows/IPPD/sampleWorkflow/comet_LS002_thirdOnly_V3.xml'])		### call Kepler, specify workflow name here.
