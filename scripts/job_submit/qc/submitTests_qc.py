...
# Map the param names to the corresponding list
params = {
    'module' : module_list,
    'sample' : sample_list,
    'ppn' : ppn_list,
...
for i in range (0, num_combs):
    ...
    WorkflowLocation = '/Users/arvind/Projects/ippd/workflows/comet_xml/comet_qc.xml'
    ...
    realRemoteSampleDir = realRemoteDir + "/" + SampleName + "/dataFiles.qc"
    realRemoteErrorDir =  realRemoteSampleDir +"/qsubErrOut" # + JobFolderName 
    ...
    # Input files for QC
    Input1 = "rand1_" + seqlen + ".seq"
    Input2 = "rand2_" + seqlen + ".seq"
