...
+ RemoteScriptDir + "/ann_batch_run_dir.pl --INDIR1=" + Input1 + " --OUTDIR1=" + TrialOutputDir + "/usr/bin/time -v "  + RemoteToolDir + "/fr-hit -T 16 -r 25 -m 60 -c 70 -p 8 -a {INDIR1} -d " + RemoteRefDir + "/ncbi-genomes/ref_all_2013_0429.nr80 -o {OUTDIR1}" + " "
